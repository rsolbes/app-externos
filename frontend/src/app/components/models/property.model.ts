// property.model.ts
// Modelo basado en tu estructura de base de datos de Access
...
export interface Property {
  ...
  // Campo de imagen de Access (viene como base64 string desde el backend)
  Imagen: string | null; // ← Así viene de tu BD de Access
